...
APP_NAME="${APP_NAME:-demo-server1}"

# Cluster Client 配置
TOKEN_SERVER_HOST="${TOKEN_SERVER_HOST:-token-server}"
TOKEN_SERVER_PORT="${TOKEN_SERVER_PORT:-18730}"
REQUEST_TIMEOUT="${REQUEST_TIMEOUT:-2000}"
...
echo "========================================="
echo "Demo Server - Cluster Client Mode"
echo "========================================="
echo "App Name: ${APP_NAME}"
echo "Java Version: ${JAVA_VER}"
echo "HTTP Server Port: ${SERVER_PORT}"
echo "Token Server: ${TOKEN_SERVER_HOST}:${TOKEN_SERVER_PORT}"
...
# Cluster Client 配置
SENTINEL_OPTS="${SENTINEL_OPTS} -Dcsp.sentinel.cluster.mode=2"  # 2 = Token Client
SENTINEL_OPTS="${SENTINEL_OPTS} -Dcsp.sentinel.cluster.token.server.host=${TOKEN_SERVER_HOST}"
SENTINEL_OPTS="${SENTINEL_OPTS} -Dcsp.sentinel.cluster.token.server.port=${TOKEN_SERVER_PORT}"
SENTINEL_OPTS="${SENTINEL_OPTS} -Dcsp.sentinel.cluster.client.request.timeout=${REQUEST_TIMEOUT}"

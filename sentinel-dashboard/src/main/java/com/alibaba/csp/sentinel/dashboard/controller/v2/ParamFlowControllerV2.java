...
/**
 * Param flow rule controller V2 (for frontend integration).
 */
@RestController
@RequestMapping(value = "/v2/paramFlow")
public class ParamFlowControllerV2 {

    private final Logger logger = LoggerFactory.getLogger(ParamFlowControllerV2.class);
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryRules(@RequestParam String app) {
    ...
    public Result<ParamFlowRuleEntity> apiUpdateRule(@PathVariable("id") Long id,
        ...
        try {
            ...
            logger.error("Failed to update param flow rule", throwable);
            return Result.ofThrowable(-1, throwable);
        }
        return Result.ofSuccess(entity);
    }
    ...
    private <R> Result<R> checkEntityInternal(ParamFlowRuleEntity entity) {
        ...
        if (entity.getGrade() != 0 && entity.getGrade() != 1) {
            return Result.ofFail(-1, "grade must be 0 or 1");
        }

...
public class FlowRuleNacosPublisher implements DynamicRulePublisher<List<FlowRuleEntity>> {
    ...
    public void publish(String app, List<FlowRuleEntity> rules) throws Exception {
        ...
        String group = NacosConfigUtil.getGroupId();
        String content = converter.convert(rules);
        
        logger.info("[Nacos] Publishing flow rules: dataId={}, group={}, rules count={}", 
                    dataId, group, rules.size());
        
        boolean result = configService.publishConfig(dataId, group, content);
        
        logger.info("[Nacos] Publish result: {}", result);
    }
}
